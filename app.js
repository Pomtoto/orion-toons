/* ============================================================
   أوريون · توونز — تطبيق Express (بدون listen)
   يُستورد من server.js (تشغيل محلي) أو api/index.js (فيرسيل)
   ============================================================ */
import express from 'express';
import cors from 'cors';
import path from 'node:path';
import { fileURLToPath } from 'node:url';
import { searchWorks, getWork, getChapters, getPages, ORIGINS } from './lib/mangadex.js';
import { translateImage, isConfigured } from './lib/ocr.js';
...
/* ============ robots.txt + خريطة الموقع (SEO) ============
   يجب تسجيلهما قبل express.static ليتم توليدهما ديناميكياً */
