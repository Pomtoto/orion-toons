/* ============================================================
   أوريون · توونز — نسخة مسطّحة (بدون مجلدات) للنشر على Vercel
   app.js = تطبيق Express الكامل + تقديم الواجهة الأمامية
   ============================================================ */
...
/* قراءة الملفات الثابتة مرة واحدة (أداء أعلى + يعمل في Serverless) */
